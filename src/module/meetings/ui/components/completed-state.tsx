    ...
    return(
        <div className="flex flex-col gap-y-4">
            <Tabs defaultValue="summary">
                <div className="bg-white rounded-lg border-white px-3">
                    <ScrollArea>
                        <TabsList className="p-0 background justify-start rounded-none h-13 ">
                            <TabsTrigger value="summary" 
                            className="text-muted-foreground rounded-none bg-background 
                            data-[state=active]:shadow-none border-b02 border-transparent 
                ...
                <TabsContent value="recording">
                    <div className="bg-white rounded-lg border-white px-4 py-5">
                        <video 
                ...
                <TabsContent value="summary">
                    <div className="bg-white rounded-lg border-white">
