...
export const Transcript = ({meetingId}: Props) =>{
    ...
    return(
        <div className="bg-white rounded-lg border-white px-4 py-5 flex flex-col gap-y-4 w-full">
            ...
            <ScrollArea>
                <div className="flex flex-col gap-y-4">
                    {filteredData.map((item) => {
                        return(
                            <div key={item.start_ts} className="flex flex-col gap-y-2 hover:bg-muted p-4 rounded-md border-white">
