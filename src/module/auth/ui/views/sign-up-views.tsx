          ...
          <Form {...form}>
            ...
            >
              <div className="flex flex-col gap-5">
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            ...
                            className="h-10 rounded-xl bg-white/[0.04] border-purple-500/20 text-white placeholder:text-purple-300/30 focus-visible:border-purple-400 focus-visible:ring-2 focus-visible:ring-purple-500/30 transition-all"
                            {...field}
                          />
                        </FormControl>
                ...
                <p className="text-center text-xs text-purple-200/50 mt-1">
          ...
          <div className="relative hidden md:flex flex-col items-center justify-between p-10 overflow-hidden bg-gradient-to-br from-[#4C1D95] via-[#2E1065] to-[#120429]">
            ...
            <div className="relative z-10 flex flex-col items-center text-center my-auto">
              ...
              <p className="mt-2.5 max-w-[240px] text-xs leading-relaxed text-purple-200/75">
                Practice smarter with AI-powered mock interviews, instant transcript feedback, and speech analytics.
              </p>
